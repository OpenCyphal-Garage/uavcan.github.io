...
<a  href="/Specification/figures/architecture.png">
<img src="/Specification/figures/architecture.png" style="float: right; max-width: 25%"/>
</a>
...
In some cases, the node may require more complex configuration than can be conveniently managed via these services.
...
For example, parameter for the field `esc_index` that is used in the message `uavcan.equipment.esc.Status`
...
<a  href="/Specification/figures/dynamic_node_id_allocatee_algorithm.svg">
<img src="/Specification/figures/dynamic_node_id_allocatee_algorithm.svg" style="max-width: 75%"/>
</a>
