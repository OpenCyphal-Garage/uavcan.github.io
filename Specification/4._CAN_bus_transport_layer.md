...
* Service transfer transmission should be aborted if it could not complete in 1 second.
* The client should stop waiting for response from the server if the response did not arrive in 1 second.
