...
**UAVCAN M8**       |Generic circular M8 5-circuit B-coded  |24 V               |3 A        |CiA 103 (CANopen)
...
UAVCAN M8 connector is based on the standard circular M8 B-coded 5-circuit connector type (pictured).
...
The UAVCAN M8 connector is based on the industry-standard M8 B-coded 5-circuit connector type.
Devices are equipped with the male plug connector type (see the image) mounted on the panel or on the PCB,
and the cables are equipped with the female socket connectors on both ends.
