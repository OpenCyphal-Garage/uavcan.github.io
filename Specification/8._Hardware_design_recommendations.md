...
**Do not deviate from the recommendations provided in this section, as this may impact cross-vendor compatibility.**
...
The following table provides a summarizes all of the currently defined connector types.
...
The UAVCAN D-Sub connector type is based upon, and compatible with, the the D-Subminiature DE-9 CAN connector (this is the most popular CAN connector type, in effect the de-facto industry standard). 
