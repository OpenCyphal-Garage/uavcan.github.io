...
* Message broadcasting - The primary method of data exchange with all to all publishing semantics.
...
Message broadcasting refers to the transmission of a serialized data structure over the CAN bus to all other nodes. This is the primary UAVCAN data exchange mechanism.
