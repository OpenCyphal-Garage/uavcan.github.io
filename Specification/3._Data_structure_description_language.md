...
This directive instructs the DSDL compiler that the current data type is a tagged union.
...
data structure is holding at the moment. The following chapters define the encoding rules for tagged unions.
